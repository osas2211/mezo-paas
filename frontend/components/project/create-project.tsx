...
export const CreateProject = () => {
  ...
  const { mutateAsync: createproject, isPending: isDeploying } =
    useCreateProject()

  const handleSelectRepo = (repo: GithubRepoI) => {
                    ...
                    filteredRepos.map((repo: GithubRepoI, index: number) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="shrink-0 ml-4 px-4 py-1.5 text-xs font-medium border border-white/20 text-white/80 hover:bg-white hover:text-black hover:border-white transition-all duration-200 flex items-center gap-1.5"
                        >
                          Import
                        </button>
                      </motion.div>
                  ...
                  <div className="flex gap-3 items-center">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-white/40 mt-0.5">
                        Make sure the GitHub App is installed and has access to
