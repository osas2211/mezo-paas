...
export class GithubController {
  ...
  async callback(
    ...
    try {
      ...
      const githubUser = await this.githubService.getGithubUser(
        generated_accessToken,
      );
  ...
  async getRepos(
    ...
    return this.githubService.fetchInstallationRepos(
      ...
      search,
      limit ? parseInt(limit, 15) : undefined,
  ...
  async importRepo(
    ...
    const repo = await this.githubService.fetchSingleRepoDatails(
    ...
    return this.githubService.importRepo(
      repoName,
      repo.default_branch,
      access_token,
      user?.githubUsername as string,
